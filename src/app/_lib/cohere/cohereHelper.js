...
export const generatePrompt = async (theme) => {
  const response = await cohere.chat({
    message: `Generate a pro-con debate topic on the theme of ${theme} where each side will only speak once and for around 30 seconds each. Avoid controversial topics. Do not format with Markdown. Do not make a argument for the debate, only generate the topic. The topic should be 1 sentence.`,
    stream: false,
